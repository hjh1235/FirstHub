...
{  
    ...
    public  class FtpUpd
    {
        ...
        public FtpUpd(string host, string userId, string password)
        ...
        public FtpUpd(string host, string userId, string password, int port, IWebProxy proxy, bool enableSsl, bool useBinary, bool usePassive)
        {
            this.userId = userId;
        ...
        public bool Download(string serverName, string localName)
        {
            ...
            using (FileStream fs = new FileStream(localName, FileMode.Create)) //创建或打开本地文件
            {
                ...
                request.ContentOffset = 0;// fs.Length;
        ...
        public bool UploadStream(Stream stream, string remoteFileName)
        {
            bool result = false;
            try
            {
